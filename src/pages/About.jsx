    ...
    <div>
        <div >
              ...
              <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                  <header className='mx-auto py-20 text-4xl font-semibold lg:w-[70%]'>
                    ...
                    <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>
                      EduLearn is at the forefront of driving innovation in online education. We're passionate about 
              ...
              <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
                  ...
                  <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                      ...
                      <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                          ...
                          <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            ...
                            for accessible, flexible, and high-quality learning oppertunities in a rapidly evolving digital world.
                          </p>
                          <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            ...
                            geographical boundaries. We envisioned a platform that could bridge these gaps and empower individuals from all 
                  ...
                  <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                      ...
                      <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                          ...
                          <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            With this vision in mind, we set out o a journey to create an e-leaning platform that would revolutionize the
                            way people learn. OUr team of dedicated experts worked tirelessly to develop a robust and intuitive platform 
                      ...
                      <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                          ...
                          <p className='text-base font-medium text-richblack-300 lg:w-[95%]'>
                            ...
                            of sharing and dialogue, and we foster this spirit of collaboration through forums, live sessions, and networking oppertunities.
                          </p>
                      </div>
                  </div>
              </div>
            ...
            <section className='mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white'>
                ...
                {/* contact form section is pending here  */}
